...
public class XMLLookUpStrings {
	
	final static String DIV = "DIV";
	final static String H1_HEAD1 = "H1-Head1";
	final static String SH1_SUBHEAD1 = "SH1-Subhead1";
	final static String BP_BODY = "BP-Body";
	final static String NOTEHEAD = "NH-NoteHead";
	final static String NOTEBODY = "NB-NoteBody";
	final static String TABLE = "TABLE";
	final static String TABLE_HEAD = "TH-TblHead";
